<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Site1.Master" AutoEventWireup="true" CodeBehind="EnergyWater.aspx.cs" Inherits="IERM.Views.EnergyWater" %>
            ...
            <div class="panel-body" style="min-height: 580px;">
                <div class="row-fluid form-inline">
                    <ul class="nav nav-tabs" role="tablist" id="eleTab">    
                        <li role='presentation'><a data-tid="0" href='#eleinfo' role='tab' data-toggle='tab'>用水能耗汇总</a></li>               
                    </ul>
                    <div class="tab-content" id="elecontent">   
                        <div role='tabpanel' class='tab-pane fade in active' id='eleinfo'><div id='eleinfo-content' class='form-group col-lg-12' style='height: 600px;'></div></div>
                    </div>
                </div>
            </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cph_script" runat="server">
    ...
    <script type="text/javascript">
        ...
        function initElePanel(index) {
            $.getJSON("../Handler/EnergyHandler.ashx?action=getenrgytmpl&pID=2&r=" + Math.random(), null, function (res) {
                if (res.IsSucceed) {
