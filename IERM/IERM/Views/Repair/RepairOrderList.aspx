<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Views/Site1.Master" CodeBehind="RepairOrderList.aspx.cs" Inherits="IERM.Views.Repair.RepairOrderList" %>
    ...
    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-lg modal-dialog">
            <div class="modal-content">
                <form id="repairForm" class="form-horizontal" role="form">
                    ...
                    <div class="modal-body">
                        <div class="tab-pane" id="tab1">
                            <div id="left" class="col-lg-5">
                                ...
                                <div class="form-group">
                                    <label for="modalReason" class="control-label">维修原因：</label>
                                    <div class="col-sm-10">
                                        <textarea id="modalReason" rows="10" class="form-control" style="resize: none"></textarea>
                                    </div>
                                </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cph_script" runat="server">
    ...
    <script type="text/javascript">
        ...
        function initTable() {
            ...
            //先销毁表格  
            $('#tb_repair').bootstrapTable('destroy');
            //初始化表格,动态从服务器加载数据  
            $("#tb_repair").bootstrapTable({
                method: "get",  //使用get请求到服务器获取数据  
                url: "/Handler/RepairOrderHandler.ashx?action=getrepairorderlist&r=" + Math.random(), //获取数据的Servlet地址  
                striped: true,  //表格显示条纹  
    ...
    <script>
        function save() {
            ...
            if (tree.length > 0) {
                ...
                $('#myModal').modal('hide');
                //新增
                $.post("/Handler/RepairOrderHandler.ashx",
                    {
                        "action": "AddRepairOrder",
        ...
        function send(row) {
            ...
            layer.open({
                ...
                area: ['30%', '40%'],
                content: '/Views/Repair/RepairOrderSend.aspx?orderID=' + row.order_id + "&communityID=" + row.community_id + "&orderSN=" + row.order_sn,
            });
        }
        function detail(row) {
            window.location = "/Views/Repair/RepairOrderDetail.aspx?orderID=" + row.order_id;
        }
        function alertHide() {
            setTimeout(function () { $('#alertMsg').hide(); }, 3000);
        }
