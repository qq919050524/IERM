<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Views/Site1.Master" CodeBehind="RepairUserOrderList.aspx.cs" Inherits="IERM.Views.Repair.RepairUserOrderList" %>
                        ...
                        <div class="tab-pane" id="tab1">
                            <div class="col-lg-10">
                                <div class="form-group">
                                    <div class="col-sm-2">
                                        <label for="orderID" class="control-label">工单id：</label>
                                    </div>
                                    <div class="col-sm-8">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-2">
                                        <label for="orderSN" class="control-label">工单编号：</label>
                                    </div>
                                    <div class="col-sm-8">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-2">
                                        <label for="implement_content" class="control-label">实施内容：</label>
                                    </div>
                                    <div class="col-sm-8">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-2">
                                        <label for="adImg" class="control-label">上传图片：</label>
                                    </div>
                                    <div class="col-sm-10">
    ...
    <script type="text/javascript">
        ...
        function initTable() {
            ...
            $("#tb_repair").bootstrapTable({
                ...
                url: "/Handler/RepairOrderHandler.ashx?action=getrepairuserorderlist&r=" + Math.random(), //获取数据的Servlet地址  
                striped: true,  //表格显示条纹  
        ...
        function save() {
            if (vail()) {//验证参数，才能提交保存
                ...
                $.post("../../Handler/ImplementHandler.ashx",
                    {
                        "action": "addrepairimplement",
                        "orderid": order_id,
                        "ordersn": order_sn,
                        "content": content,
                        "imgurl": imgurl,
                        "type": 3 //1巡检2维保3维修，此处用3
                    },
                    function (res) {
                        if (res.IsSucceed) {
                            $('#myModal').modal('hide');
                ...
                $("#implement_content").val("");
                $("#hidimg").val("");
                $adImg.fileinput("refresh").fileinput("enable");
            }
        }
        //详情
        function detail(row) {
