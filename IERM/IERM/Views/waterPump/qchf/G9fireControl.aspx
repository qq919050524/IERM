<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Site1.Master" AutoEventWireup="true" CodeBehind="G9fireControl.aspx.cs" Inherits="IERM.Views.waterPump.qchf.G9fireControl" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cph_script" runat="server">
    <script type="text/javascript">
        ...
        function LoadData() {
            $.getJSON("/Handler/WCFHandler.ashx?action=getdatabydevhouseid&r=" + Math.random(), { "devhouseID": 20 }, function (res) {
                if (res.IsSucceed) {
                    //消防供水-消防1#供水压力
