<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Site1.Master" AutoEventWireup="true" CodeBehind="G10WaterPump.aspx.cs" Inherits="IERM.Views.waterPump.qchf.G10WaterPump" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cph_css" runat="server">
    <link href="/css/beng/nine.css" rel="stylesheet" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cph_body" runat="server">
    ...
    <div class="introImg vertical">
        ...
        <div class="ImgWarp">
            <img src="/img/beng/9beng/nineBac.png" class="nineImg">
            <!--高区供水-->
...
<asp:Content ID="Content3" ContentPlaceHolderID="cph_script" runat="server">
    <script type="text/javascript">
        ...
        function LoadData() {
            $.getJSON("/Handler/WCFHandler.ashx?action=getdatabydevhouseid&r=" + Math.random(), { "devhouseID": 19 }, function (res) {
                if (res.IsSucceed) {
