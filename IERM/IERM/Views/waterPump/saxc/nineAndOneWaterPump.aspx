<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Site1.Master" AutoEventWireup="true" CodeBehind="nineAndOneWaterPump.aspx.cs" Inherits="IERM.Views.waterPump.saxc.nineAndOneWaterPump" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cph_css" runat="server">
    <link href="/css/beng/nineAndOne.css" rel="stylesheet" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cph_body" runat="server">
    ...
    <div class="introImg vertical">
        ...
        <div class="ImgWarp">
            <img src="/img/beng/nineAndOne/bac.png" class="bengImg">
            <!--高区供水-->
...
<asp:Content ID="Content3" ContentPlaceHolderID="cph_script" runat="server">
    <script type="text/javascript">
        ...
        function LoadData() {
            $.getJSON("/Handler/WCFHandler.ashx?action=getdatabydevhouseid&r=" + Math.random(), { "devhouseID": 4 }, function (res) {
                if (res.IsSucceed) {
