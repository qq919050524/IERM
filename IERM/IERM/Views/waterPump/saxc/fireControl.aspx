<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Site1.Master" AutoEventWireup="true" CodeBehind="fireControl.aspx.cs" Inherits="IERM.Views.waterPump.saxc.fireControl" %>

<asp:Content ID="Content1" ContentPlaceHolderID="cph_css" runat="server">
    <link href="/css/beng/saxcXf.css" rel="stylesheet" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cph_body" runat="server">
    ...
    <div class="introImg vertical">
        ...
        <div class="ImgWarp">
            <img src="/img/beng/xf/saxcFireControl.png" class="bengImg">
            <!--消防管网供水-->
            <span class="xfgwTemOne temperature">--</span>
            <span class="xfgwTemTwo temperature">--</span>
            <span class="xfgwTagOne tag tz"></span>
            <span class="xfgwTagTwo tag tz"></span>
            <!--喷淋管网供水-->
            <span class="plgwTemOne temperature">--</span>
            <span class="plgwTemTwo temperature">--</span>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cph_script" runat="server">
    <script type="text/javascript">
        ...
        function LoadData() {
            $.getJSON("/Handler/WCFHandler.ashx?action=getdatabydevhouseid&r=" + Math.random(), { "devhouseID": 5 }, function (res) {
                if (res.IsSucceed) {
                    //消防供水-消防1#供水压力
                    $(".xfgwTemOne").text(res.Data.P_XF1);
                    //消防供水-喷淋1#供水压力
                    $(".plgwTemOne").text(res.Data.P_PL1);
                    //消防供水-消防2#供水压力
                    $(".xfgwTemTwo").text(res.Data.P_XF2);
                    //消防供水-喷淋2#供水压力
                    $(".plgwTemTwo").text(res.Data.P_PL2);
                    //消防管网运行状态
