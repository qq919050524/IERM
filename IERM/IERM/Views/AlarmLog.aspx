<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Site1.Master" AutoEventWireup="true" CodeBehind="AlarmLog.aspx.cs" Inherits="IERM.Views.AlarmLog" %>
    ...
    <script type="text/javascript">
        ...
        function initTable() {
            ...
            $("#tb_alarm").bootstrapTable({
                ...
                url: "../Handler/AlarmHandler.ashx?action=getalarmlog&r=" + Math.random(), //获取数据的Servlet地址  
                striped: true,  //表格显示条纹  
