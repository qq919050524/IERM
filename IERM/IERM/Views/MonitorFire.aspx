<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Site1.Master" AutoEventWireup="true" CodeBehind="MonitorFire.aspx.cs" Inherits="IERM.Views.MonitorFire" %>
<asp:Content ID="Content1" ContentPlaceHolderID="cph_css" runat="server">
    <link href="../css/xiaofang/xf.css" rel="stylesheet" />
</asp:Content>
            ...
            <div class="index">
                <div class="container-16">
                    <div class="subcontainer">
                        ...
                        <div class="shuibeng">
                            <div class="shui">
                                <img src="../img/xiaofang/xfbac.png" class="bengImg">
                                <!--消防管网供水-->
                                <span class="xfgwTem temperature">000.0</span>
                                <span class="xfgwTagOne tag yx"></span>
                                <span class="xfgwTagTwo tag yx"></span>
                                <!--喷淋管网供水-->
                                <span class="plgwTem temperature">000.0</span>
                                <span class="plgwTagOne tag yx"></span>
                                <span class="plgwTagTwo tag yx"></span>
                                <!--水箱温度-->
