<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Views/Site1.Master" CodeBehind="MaintenanceOrderDetail.aspx.cs" Inherits="IERM.Views.Maintenance.MaintenanceOrderDetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_body" runat="server">
    ...
    <div class="col-xs-12">
        <h3 class="header">
            <span class="col-sm-6">维保工单-详情</span>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cph_script" runat="server">
    ...
    <script type="text/javascript">
        ...
        function initEquipmentTable() {
            ...
            $("#tb_equipment").bootstrapTable({
                ...
                url: "/Handler/MaintenanceOrderHandler.ashx?action=getorderequipment&r=" + Math.random(), //获取数据的Servlet地址  
                striped: true,  //表格显示条纹  
                height: 300,
    ...
    <script type="text/javascript">
        ...
        function initImplementTable() {
            var orderID = $('#<% =orderID.ClientID%>').val();
            //先销毁表格  
            $('#tb_implement').bootstrapTable('destroy');
            //初始化表格,动态从服务器加载数据  
            $("#tb_implement").bootstrapTable({
                method: "get",  //使用get请求到服务器获取数据  
                url: "/Handler/MaintenanceOrderHandler.ashx?action=getorderimplementlist&r=" + Math.random(), //获取数据的Servlet地址  
                striped: true,  //表格显示条纹  
                height: 300,
                toolbar: '#toolbar',                //工具按钮用哪个容器
                pagination: true, //启动分页  
