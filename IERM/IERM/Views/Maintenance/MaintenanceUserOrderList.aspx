<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Views/Site1.Master" CodeBehind="MaintenanceUserOrderList.aspx.cs" Inherits="IERM.Views.Maintenance.MaintenanceUserOrderList" %>
    ...
    <script type="text/javascript">
        ...
        function initTable() {
            ...
            $("#tb_maintenance").bootstrapTable({
                ...
                url: "/Handler/MaintenanceOrderHandler.ashx?action=getmaintenanceuserorderlist&r=" + Math.random(), //获取数据的Servlet地址 
                striped: true,  //表格显示条纹  
        ...
        function save() {
            if (vail()) {//验证参数，才能提交保存
                ...
                $.post("../../Handler/ImplementHandler.ashx",
                    {
                        "action": "addmaintenanceimplement",
                        "orderid": order_id,
                        "ordersn": order_sn,
                        "content": content,
                        "imgurl": imgurl,
                        "type": 2 //1巡检2维保3维修，此处用2
                    },
                    function (res) {
                        if (res.IsSucceed) {
                            $('#myModal').modal('hide');
