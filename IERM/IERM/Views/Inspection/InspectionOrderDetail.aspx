<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Views/Site1.Master" CodeBehind="InspectionOrderDetail.aspx.cs" Inherits="IERM.Views.Inspection.InspectionOrderDetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_body" runat="server">
    ...
    <div class="col-xs-12">
        <h3 class="header">
            <span class="col-sm-6">巡检工单-详情</span>
    ...
    <script type="text/javascript">
        ...
        function initEquipmentTable() {
            ...
            $("#tb_equipment").bootstrapTable({
                ...
                url: "/Handler/InspectionOrderHandler.ashx?action=getorderequipment&r=" + Math.random(), //获取数据的Servlet地址  
                striped: true,  //表格显示条纹  
                height: 300,
    ...
    <script type="text/javascript">
        ...
        function initImplementTable() {
            ...
            $("#tb_implement").bootstrapTable({
                method: "get",  //使用get请求到服务器获取数据  
                url: "/Handler/InspectionOrderHandler.ashx?action=getorderimplementlist&r=" + Math.random(), //获取数据的Servlet地址  
                striped: true,  //表格显示条纹  
                height: 300,
                toolbar: '#toolbar',                //工具按钮用哪个容器
                pagination: true, //启动分页  
