<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Views/Site1.Master" CodeBehind="InspectionOrderList.aspx.cs" Inherits="IERM.Views.Inspection.InspectionOrderList" %>
    ...
    <script type="text/javascript">
        ...
        function initTable() {
            ...
            $("#tb_Inspection").bootstrapTable({
                ...
                url: "/Handler/InspectionOrderHandler.ashx?action=getInspectionorderlist&r=" + Math.random(), //获取数据的Servlet地址  
                striped: true,  //表格显示条纹  
    ...
    <script>
        ...
        function save() {
            ...
            if (tree.length > 0) {
                ...
                $('#myModal').modal('hide');
                //新增
                $.post("/Handler/InspectionOrderHandler.ashx",
                    {
                        "action": "AddInspectionOrder",
        ...
        function send(row) {
            ...
            layer.open({
                ...
                area: ['30%', '40%'],
                content: '/Views/Inspection/InspectionOrderSend.aspx?orderID=' + row.order_id + "&communityID=" + row.community_id + "&orderSN=" + row.order_sn,
            });
        }
        //详情
        function detail(row) {
