<%@ Page Language="C#" MasterPageFile="~/Views/Site1.Master" AutoEventWireup="true" CodeBehind="ElevatorCurrentAlarm.aspx.cs" Inherits="IERM.Views.Elevator.ElevatorCurrentAlarm" %>
    ...
    <script type="text/javascript">
        ...
        function initTable() {
            ...
            $("#tb_alarm").bootstrapTable({
                ...
                url: "/Handler/ElevatorHandler.ashx?action=getcurrentalarmelevator&r=" + Math.random(), //获取数据的Servlet地址  
                striped: true,  //表格显示条纹  
