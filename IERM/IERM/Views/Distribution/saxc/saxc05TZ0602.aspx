<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Site1.Master" AutoEventWireup="true" CodeBehind="saxc05TZ0602.aspx.cs" Inherits="IERM.Views.saxc.saxc05TZ0602" %>
    ...
    <div class="introImg vertical">
        ...
        <div class="center">
            ...
            <ul class="centerUl">
                ...
                <li class="centerLi">
                    <a class="xfdt">G10-2</a>
                    <a class="bg">消防梯、排烟梯</a>
                    <span class="ulFen status"></span>
                    <span class="redArr"></span>
                </li>
                <li class="centerLi">
        ...
        <div class="center">
            ...
            <ul class="centerUl">
                <li class="centerLi">
                    <a class="xfdt">G9-2应急照明</a>
                    <a class="bg">备用</a>
                    <span class="ulFen status"></span>
                    <span class="redArr"></span>
                </li>
                <li class="centerLi">
                    <a class="xfdt">G10-2应急照明</a>
                    <a class="bg">备用</a>
                    <span class="ulFen status"></span>
                    <span class="redArr"></span>
                </li>
                ...
                <li class="centerLi">
                    <a class="xfdt">G9-1应急照明</a>
                    <a class="bg">备用</a>
                    <span class="ulFen status"></span>
                    <span class="redArr"></span>
                </li>
                <li class="centerLi">
                    <a class="xfdt">G10-1应急照明</a>
                    <a class="bg">备用</a>
                    <span class="ulFen status"></span>
                    <span class="redArr"></span>
                </li>
                <li class="centerLi">
                    <a class="xfdt">地下室应急照明</a>
                    <a class="bg">备用</a>
                    <span class="ulFen status"></span>
                    <span class="redArr"></span>
                </li>
        ...
        <div class="center">
            ...
            <ul class="centerUl">
                <li class="centerLi">
                    <a class="xfdt">G9-2消防梯</a>
                    <a class="bg">(主供)</a>
                    <span class="ulFen status"></span>
                    <span class="redArr"></span>
                </li>
                <li class="centerLi">
                    <a class="xfdt">G9-1消防梯</a>
                    <a class="bg">(主供)</a>
                    <span class="ulFen status"></span>
                    <span class="redArr"></span>
                </li>
                <li class="centerLi">
                    <a class="xfdt">G10-2消防梯</a>
                    <a class="bg">(主供)</a>
                    <span class="ulFen status"></span>
                    <span class="redArr"></span>
                </li>
                <li class="centerLi">
                    <a class="xfdt">G10-1消防梯</a>
                    <a class="bg">(主供)</a>
                    <span class="ulFen status"></span>
                    <span class="redArr"></span>
                </li>
        ...
        <div class="center">
            ...
            <ul class="centerUl">
                <li class="centerLi">
                    <a class="xfdt">G9-2客梯</a>
                    <a class="bg">(主供)</a>
                    <span class="ulFen status"></span>
                    <span class="redArr"></span>
                </li>
                <li class="centerLi">
                    <a class="xfdt">G9-1客梯</a>
                    <a class="bg">(主供)</a>
                    <span class="ulFen status"></span>
                    <span class="redArr"></span>
                </li>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cph_script" runat="server">
    <script type="text/javascript">
        (function () {
            ...
            $(".wordWarp").css("height", "7.2%"); LoadData();
            setInterval(function () { LoadData(); }, 10000);
        })();

        function LoadData() {
            $.getJSON("/Handler/WCFHandler.ashx?action=getdatabydevhouseid&r=" + Math.random(), { "devhouseID": 10 }, function (res) {
                if (res.IsSucceed) {
