<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Site1.Master" AutoEventWireup="true" CodeBehind="saxc01T302.aspx.cs" Inherits="IERM.Views.saxc.saxc01T302" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_body" runat="server">
    ...
    <div class="introImg vertical">
        ...
        <div class="ele">
            ...
            <span class="eleLogo">
                <img src="/img/bpd/tengui.jpg" class="eleImg">
            </span>
        </div>
        <div class="twe">
            <ul class="introOne">
        ...
        <div class="center">
            ...
            <ul class="centerUl">
                ...
                <li class="centerLi">
                    <a class="xfdt"></a>
                    <a class="bg">G3-2景观照明</a>
                    <span class="ulFen status"></span>
                    <span class="redArr"></span>
                </li>
                <li class="centerLi">
                    <a class="xfdt"></a>
                    <a class="bg">G3-1景观照明</a>
                    <span class="ulFen status"></span>
                    <span class="redArr"></span>
                </li>
                <li class="centerLi">
                    <a class="xfdt"></a>
                    <a class="bg">G2-2景观照明</a>
                    <span class="ulFen status"></span>
                    <span class="redArr"></span>
                </li>
                <li class="centerLi">
                    <a class="xfdt"></a>
                    <a class="bg">G2-1景观照明</a>
                    <span class="ulFen status"></span>
                    <span class="redArr"></span>
                </li>
                <li class="centerLi">
        ...
        function LoadData() {
            $.getJSON("/Handler/WCFHandler.ashx?action=getdatabydevhouseid&r=" + Math.random(), { "devhouseID": 6 }, function (res) {
                if (res.IsSucceed) {
                    ...
                    res.Data.N2_G5.f8 ? $(".centerUl:eq(4) .centerLi:eq(7)").find("span:eq(0)").attr("class", "ulHe status") : $(".centerUl:eq(4) .centerLi:eq(7)").find("span:eq(0)").attr("class", "ulFen status");
                    res.Data.N2_G5.f9 ? $(".centerUl:eq(4) .centerLi:eq(8)").find("span:eq(0)").attr("class", "ulHe status") : $(".centerUl:eq(4) .centerLi:eq(8)").find("span:eq(0)").attr("class", "ulFen status");
                    ...
                    res.Data.N2_G6.f7 ? $(".centerUl:eq(5) .centerLi:eq(6)").find("span:eq(0)").attr("class", "ulHe status") : $(".centerUl:eq(5) .centerLi:eq(6)").find("span:eq(0)").attr("class", "ulFen status");
                    res.Data.N2_G6.f8 ? $(".centerUl:eq(5) .centerLi:eq(7)").find("span:eq(0)").attr("class", "ulHe status") : $(".centerUl:eq(5) .centerLi:eq(7)").find("span:eq(0)").attr("class", "ulFen status");
                    res.Data.N2_G6.f9 ? $(".centerUl:eq(5) .centerLi:eq(8)").find("span:eq(0)").attr("class", "ulHe status") : $(".centerUl:eq(5) .centerLi:eq(8)").find("span:eq(0)").attr("class", "ulFen status");
