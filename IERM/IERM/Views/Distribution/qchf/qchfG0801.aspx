<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Site1.Master" AutoEventWireup="true" CodeBehind="qchfG0801.aspx.cs" Inherits="IERM.Views.Distribution.qchf.qchfG0801" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_body" runat="server">
    ...
    <div class="introImg vertical">
        ...
        <div class="center">
            ...
            <ul class="centerUl">
                <li class="centerLi">
                    <a class="xfdt">6#楼消防电梯一</a>
                    <a class="bg">(主供)</a>
                    <span class="ulFen status"></span>
                    <span class="redArr"></span>
                </li>
                <li class="centerLi">
                    <a class="xfdt">6#楼消防电梯二</a>
                    <a class="bg">(主供)</a>
                    <span class="ulFen status"></span>
                    <span class="redArr"></span>
                </li>
                <li class="centerLi">
                    <a class="xfdt">7#楼消防电梯二</a>
                    <a class="bg">(主供)</a>
                    <span class="ulFen status"></span>
                    <span class="redArr"></span>
                </li>
                ...
                <li class="centerLi">
                    <a class="xfdt">8#楼消防电梯一</a>
                    <a class="bg">(备供)</a>
                    <span class="ulFen status"></span>
                    <span class="redArr"></span>
                </li>
                <li class="centerLi">
                    <a class="xfdt">8#楼消防电梯二</a>
                    <a class="bg">(备供)</a>
                    <span class="ulFen status"></span>
                    <span class="redArr"></span>
                </li>
                <li class="centerLi">
                    <a class="xfdt">9#楼消防电梯一</a>
                    <a class="bg">(备供)</a>
                    <span class="ulFen status"></span>
                    <span class="redArr"></span>
                </li>
                <li class="centerLi">
                    <a class="xfdt">9#楼消防电梯二</a>
                    <a class="bg">(备供)</a>
                    <span class="ulFen status"></span>
                    <span class="redArr"></span>
                </li>
        ...
        <div class="center">
            ...
            <ul class="centerUl">
                ...
                <li class="centerLi">
                    <a class="xfdt"></a>
                    <a class="bg">7#楼客梯(主供)</a>
                    <span class="ulFen status"></span>
                    <span class="redArr"></span>
                </li>
                <li class="centerLi">
                    <a class="xfdt"></a>
                    <a class="bg">8#楼客梯(主供)</a>
                    <span class="ulFen status"></span>
                    <span class="redArr"></span>
                </li>
                <li class="centerLi">
                    <a class="xfdt"></a>
                    <a class="bg">9#楼客梯(备供)</a>
                    <span class="ulFen status"></span>
                    <span class="redArr"></span>
                </li>
                <li class="centerLi">
                ...
                <li class="centerLi">
                    <a class="xfdt"></a>
                    <a class="bg">排水泵二(主供)</a>
                    <span class="ulFen status"></span>
                    <span class="redArr"></span>
                </li>
                <li class="centerLi">
                    <a class="xfdt"></a>
                    <a class="bg">生活泵一(主供)</a>
                    <span class="ulFen status"></span>
                    <span class="redArr"></span>
                </li>
            </ul>
        ...
        <div class="center">
            ...
            <ul class="centerUl">
                <li class="centerLi">
                    <a class="xfdt">防火分区九消防负</a>
                    <a class="bg">负荷（主供）</a>
                    <span class="ulFen status"></span>
                    <span class="redArr"></span>
                </li>
                <li class="centerLi">
                    <a class="xfdt">防火分区十消防 </a>
                    <a class="bg">负荷(主供)</a>
                    <span class="ulFen status"></span>
                    <span class="redArr"></span>
                </li>
                <li class="centerLi">
                    <a class="xfdt">防火分区十七消防</a>
                    <a class="bg">负荷(主供)</a>
                    <span class="ulFen status"></span>
                    <span class="redArr"></span>
                </li>
                <li class="centerLi">
                    <a class="xfdt">防火分区十一消防</a>
                    <a class="bg">负荷(备供)</a>
                    <span class="ulFen status"></span>
                    <span class="redArr"></span>
                </li>
                <li class="centerLi">
                    <a class="xfdt">防火分区十五消防</a>
                    <a class="bg">负荷(备供)</a>
                    <span class="ulFen status"></span>
                    <span class="redArr"></span>
                </li>
                <li class="centerLi">
                    <a class="xfdt"></a>
                    <a class="bg">生活泵二(备供)</a>
                    <span class="ulFen status"></span>
                    <span class="redArr"></span>
                </li>
                <li class="centerLi">
                    <a class="xfdt">9#楼消防风机</a>
                    <a class="bg">(备用)</a>
                    <span class="ulFen status"></span>
                    <span class="redArr"></span>
                </li>
                <li class="centerLi">
                    <a class="xfdt">生活泵房风机一</a>
                    <a class="bg">(主供)</a>
                    <span class="ulFen status"></span>
                    <span class="redArr"></span>
                </li>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cph_script" runat="server">
    <script type="text/javascript">
        ...
        function LoadData() {
            $.getJSON("/Handler/WCFHandler.ashx?action=getdatabydevhouseid&r=" + Math.random(), { "devhouseID": 22 }, function (res) {
                if (res.IsSucceed) {
                    ...
                    res.Data.N1_G1.f9 ? $(".centerUl:eq(0) .centerLi:eq(8)").find("span:eq(0)").attr("class", "ulHe status") : $(".centerUl:eq(0) .centerLi:eq(8)").find("span:eq(0)").attr("class", "ulFen status");

                    //15号柜
                    res.Data.N1_G1.f1 ? $(".centerUl:eq(1) .centerLi:eq(0)").find("span:eq(0)").attr("class", "ulHe status") : $(".centerUl:eq(1) .centerLi:eq(0)").find("span:eq(0)").attr("class", "ulFen status");
                    res.Data.N1_G1.f2 ? $(".centerUl:eq(1) .centerLi:eq(1)").find("span:eq(0)").attr("class", "ulHe status") : $(".centerUl:eq(1) .centerLi:eq(1)").find("span:eq(0)").attr("class", "ulFen status");
                    res.Data.N1_G1.f3 ? $(".centerUl:eq(1) .centerLi:eq(2)").find("span:eq(0)").attr("class", "ulHe status") : $(".centerUl:eq(1) .centerLi:eq(2)").find("span:eq(0)").attr("class", "ulFen status");
                    res.Data.N1_G1.f4 ? $(".centerUl:eq(1) .centerLi:eq(3)").find("span:eq(0)").attr("class", "ulHe status") : $(".centerUl:eq(1) .centerLi:eq(3)").find("span:eq(0)").attr("class", "ulFen status");
                    res.Data.N1_G1.f5 ? $(".centerUl:eq(1) .centerLi:eq(4)").find("span:eq(0)").attr("class", "ulHe status") : $(".centerUl:eq(1) .centerLi:eq(4)").find("span:eq(0)").attr("class", "ulFen status");
                    res.Data.N1_G1.f6 ? $(".centerUl:eq(1) .centerLi:eq(5)").find("span:eq(0)").attr("class", "ulHe status") : $(".centerUl:eq(1) .centerLi:eq(5)").find("span:eq(0)").attr("class", "ulFen status");
                    res.Data.N1_G1.f7 ? $(".centerUl:eq(1) .centerLi:eq(6)").find("span:eq(0)").attr("class", "ulHe status") : $(".centerUl:eq(1) .centerLi:eq(6)").find("span:eq(0)").attr("class", "ulFen status");
                    res.Data.N1_G1.f8 ? $(".centerUl:eq(1) .centerLi:eq(7)").find("span:eq(0)").attr("class", "ulHe status") : $(".centerUl:eq(1) .centerLi:eq(7)").find("span:eq(0)").attr("class", "ulFen status");
                    ...
                    //17号柜
                    res.Data.N1_G1.f1 ? $(".centerUl:eq(3) .centerLi:eq(0)").find("span:eq(0)").attr("class", "ulHe status") : $(".centerUl:eq(3) .centerLi:eq(0)").find("span:eq(0)").attr("class", "ulFen status");
                    res.Data.N1_G1.f2 ? $(".centerUl:eq(3) .centerLi:eq(1)").find("span:eq(0)").attr("class", "ulHe status") : $(".centerUl:eq(3) .centerLi:eq(1)").find("span:eq(0)").attr("class", "ulFen status");
                    res.Data.N1_G1.f3 ? $(".centerUl:eq(3) .centerLi:eq(2)").find("span:eq(0)").attr("class", "ulHe status") : $(".centerUl:eq(3) .centerLi:eq(2)").find("span:eq(0)").attr("class", "ulFen status");
                    res.Data.N1_G1.f4 ? $(".centerUl:eq(3) .centerLi:eq(3)").find("span:eq(0)").attr("class", "ulHe status") : $(".centerUl:eq(3) .centerLi:eq(3)").find("span:eq(0)").attr("class", "ulFen status");
                    res.Data.N1_G1.f5 ? $(".centerUl:eq(3) .centerLi:eq(4)").find("span:eq(0)").attr("class", "ulHe status") : $(".centerUl:eq(3) .centerLi:eq(4)").find("span:eq(0)").attr("class", "ulFen status");
                    res.Data.N1_G1.f6 ? $(".centerUl:eq(3) .centerLi:eq(5)").find("span:eq(0)").attr("class", "ulHe status") : $(".centerUl:eq(3) .centerLi:eq(5)").find("span:eq(0)").attr("class", "ulFen status");
                    res.Data.N1_G1.f7 ? $(".centerUl:eq(3) .centerLi:eq(6)").find("span:eq(0)").attr("class", "ulHe status") : $(".centerUl:eq(3) .centerLi:eq(6)").find("span:eq(0)").attr("class", "ulFen status");
                    res.Data.N1_G1.f8 ? $(".centerUl:eq(3) .centerLi:eq(7)").find("span:eq(0)").attr("class", "ulHe status") : $(".centerUl:eq(3) .centerLi:eq(7)").find("span:eq(0)").attr("class", "ulFen status");
                    res.Data.N1_G1.f9 ? $(".centerUl:eq(3) .centerLi:eq(8)").find("span:eq(0)").attr("class", "ulHe status") : $(".centerUl:eq(3) .centerLi:eq(8)").find("span:eq(0)").attr("class", "ulFen status");


                    //18号柜
                    res.Data.N1_G1.f1 ? $(".centerUl:eq(4) .centerLi:eq(0)").find("span:eq(0)").attr("class", "ulHe status") : $(".centerUl:eq(4) .centerLi:eq(0)").find("span:eq(0)").attr("class", "ulFen status");
                    res.Data.N1_G1.f2 ? $(".centerUl:eq(4) .centerLi:eq(1)").find("span:eq(0)").attr("class", "ulHe status") : $(".centerUl:eq(4) .centerLi:eq(1)").find("span:eq(0)").attr("class", "ulFen status");
                    res.Data.N1_G1.f3 ? $(".centerUl:eq(4) .centerLi:eq(2)").find("span:eq(0)").attr("class", "ulHe status") : $(".centerUl:eq(4) .centerLi:eq(2)").find("span:eq(0)").attr("class", "ulFen status");
                    res.Data.N1_G1.f4 ? $(".centerUl:eq(4) .centerLi:eq(3)").find("span:eq(0)").attr("class", "ulHe status") : $(".centerUl:eq(4) .centerLi:eq(3)").find("span:eq(0)").attr("class", "ulFen status");
                    res.Data.N1_G1.f5 ? $(".centerUl:eq(4) .centerLi:eq(4)").find("span:eq(0)").attr("class", "ulHe status") : $(".centerUl:eq(4) .centerLi:eq(4)").find("span:eq(0)").attr("class", "ulFen status");
                    res.Data.N1_G1.f6 ? $(".centerUl:eq(4) .centerLi:eq(5)").find("span:eq(0)").attr("class", "ulHe status") : $(".centerUl:eq(4) .centerLi:eq(5)").find("span:eq(0)").attr("class", "ulFen status");
                    res.Data.N1_G1.f7 ? $(".centerUl:eq(4) .centerLi:eq(6)").find("span:eq(0)").attr("class", "ulHe status") : $(".centerUl:eq(4) .centerLi:eq(6)").find("span:eq(0)").attr("class", "ulFen status");
