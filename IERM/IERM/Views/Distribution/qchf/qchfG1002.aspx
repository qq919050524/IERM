<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Site1.Master" AutoEventWireup="true" CodeBehind="qchfG1002.aspx.cs" Inherits="IERM.Views.Distribution.qchf.qchf1002" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cph_script" runat="server">
    <script type="text/javascript">
        ...
        function LoadData() {
            $.getJSON("/Handler/WCFHandler.ashx?action=getdatabydevhouseid&r=" + Math.random(), { "devhouseID": 23 }, function (res) {
                if (res.IsSucceed) {
                    //功率因数
