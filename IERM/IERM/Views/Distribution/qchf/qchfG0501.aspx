<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Site1.Master" AutoEventWireup="true" CodeBehind="qchfG0501.aspx.cs" Inherits="IERM.Views.Distribution.qchf.qchfG0501" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_body" runat="server">
    ...
    <div class="introImg vertical">
        ...
        <div class="center">
            ...
            <ul class="centerUl">
                <li class="centerLi">
                    <a class="xfdt first">防火分区(一)消防</a>
                    <a class="bg">负荷（主供）</a>
                    <span class="ulFen status"></span>
                    <span class="redArr"></span>
                </li>
        ...
        function LoadData() {
            $.getJSON("/Handler/WCFHandler.ashx?action=getdatabydevhouseid&r=" + Math.random(), { "devhouseID": 21 }, function (res) {
                if (res.IsSucceed) {
                    ...
                    res.Data.N1_G3.f8 ? $(".centerUl:eq(2) .centerLi:eq(7)").find("span:eq(0)").attr("class", "ulHe status") : $(".centerUl:eq(2) .centerLi:eq(7)").find("span:eq(0)").attr("class", "ulFen status");
