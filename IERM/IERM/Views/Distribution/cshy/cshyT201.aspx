<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Site1.Master" AutoEventWireup="true" CodeBehind="cshyT201.aspx.cs" Inherits="IERM.Views.Distribution.cshy.cshyT201" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_body" runat="server">
    ...
    <div class="introImg vertical">
        ...
        <div class="thre">
            ...
            <span class="sideHe threFen" id="threStatus"></span>
        ...
        function LoadData() {
            $.getJSON("/Handler/WCFHandler.ashx?action=getdatabydevhouseid&r=" + Math.random(), { "devhouseID": 16 }, function (res) {
                if (res.IsSucceed) {
                    ...
                    //联络柜断路器状态
                    res.Data.N2_DRG ? $("#threStatus").attr("class", "sideHe tweHe") : $(".twe span:eq(1)").attr("class", "sideHe tweHe");
