<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Site1.Master" AutoEventWireup="true" CodeBehind="cshyT101.aspx.cs" Inherits="IERM.Views.Distribution.cshy.cshyT101" %>
    ...
    <div class="introImg vertical">
        ...
        <div class="center">
            ...
            <ul class="centerUl">
                ...
                <li class="centerLi">
                    <a class="xfdt"></a>
                    <a class="bg">4#楼泛光照明</a>
                    <span class="ulFen status"></span>
                    <span class="redArr"></span>
                </li>
                <li class="centerLi">
                    <a class="xfdt">1、2#楼</a>
                    <a class="bg">泛光照明</a>
                    <span class="ulFen status"></span>
                    <span class="redArr"></span>
                </li>
        ...
        <div class="center">
            ...
            <ul class="centerUl">
                ...
                <li class="centerLi">
                    <a class="xfdt"></a>
                    <a class="bg">4#楼物业空调一</a>
                    <span class="ulFen status"></span>
                    <span class="redArr"></span>
                </li>
                <li class="centerLi">
                    <a class="xfdt"></a>
                    <a class="bg">4#楼物业空调二</a>
                    <span class="ulFen status"></span>
                    <span class="redArr"></span>
                </li>
                <li class="centerLi">
                    <a class="xfdt"></a>
                    <a class="bg">4#楼会所照明</a>
                    <span class="ulFen status"></span>
                    <span class="redArr"></span>
                </li>
            </ul>
        ...
        <div class="center">
            ...
            <ul class="centerUl">
                ...
                <li class="centerLi">
                    <a class="xfdt">1#楼应急照明</a>
                    <a class="bg">(主供)</a>
                    <span class="ulFen status"></span>
                    <span class="redArr"></span>
                </li>
                <li class="centerLi">
                    <a class="xfdt">1#楼商场应急照明</a>
                    <a class="bg">(主供)</a>
                    <span class="ulFen status"></span>
                    <span class="redArr"></span>
                </li>
                <li class="centerLi">
                    <a class="xfdt">2#楼商场应急照明</a>
                    <a class="bg">(主供)</a>
                    <span class="ulFen status"></span>
                    <span class="redArr"></span>
                </li>
                <li class="centerLi">
                    <a class="xfdt">中央空调1#机组</a>
                    <a class="bg">(备用)</a>
                    <span class="ulFen status"></span>
                    <span class="redArr"></span>
                </li>
        ...
        <div class="center">
            ...
            <ul class="centerUl">
                <li class="centerLi">
                    <a class="xfdt">3#楼应急照明D区</a>
                    <a class="bg">(主供)</a>
                    <span class="ulFen status"></span>
                    <span class="redArr"></span>
                </li>
                <li class="centerLi">
                    <a class="xfdt">3#楼应急照明</a>
                    <a class="bg">(主供)</a>
                    <span class="ulFen status"></span>
                    <span class="redArr"></span>
                </li>
        ...
        function LoadData() {
            $.getJSON("/Handler/WCFHandler.ashx?action=getdatabydevhouseid&r=" + Math.random(), { "devhouseID": 16 }, function (res) {
                if (res.IsSucceed) {
                    ...
                    //联络柜断路器状态
                    res.Data.N1_LLG ? $(".twe span:eq(1)").attr("class", "sideHe eleHe") : $(".twe span:eq(1)").attr("class", "sideHe eleFen");
