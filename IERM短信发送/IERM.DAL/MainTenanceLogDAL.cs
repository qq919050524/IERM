...
namespace IERM.Message.DAL
{
    public class MainTenanceLogDAL
    {
        ...
        /// 增加一条数据
        /// </summary>
        public bool Add(Model.MainTenanceLogModel model)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(Model.MainTenanceLogModel model)
        {
            StringBuilder strSql = new StringBuilder();
        ...
        public MainTenanceLogModel GetModel(int mID)
        {
            ...
            Model.MainTenanceLogModel model = new Model.MainTenanceLogModel();
